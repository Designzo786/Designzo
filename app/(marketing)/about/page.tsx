...
export const metadata = {
  title: "About",
  description: "What Designzo is and the mission behind it.",
};
    ...
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
      <header className="text-center max-w-2xl mx-auto">
        ...
        <p className="mt-4 text-secondary text-base sm:text-lg leading-relaxed">
          Designzo is a marketplace for premium 3D and digital assets — a
      ...
      <section className="mt-14 rounded-2xl border border-border bg-surface p-8">
        ...
        <p className="mt-3 text-secondary leading-relaxed">
          ...
          who actually make it. We built Designzo to fix that: a clean,
