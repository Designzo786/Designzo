        ...
        <div className="max-w-3xl mx-auto text-center animate-[fade-in_0.8s_ease-out]">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-[1.05]">
            ...
            <span className="relative inline-block">
              <span className="gradient-text-hero">Your Product</span>
              <span
                aria-hidden
          ...
          <p className="mt-5 sm:mt-6 text-sm sm:text-lg text-secondary max-w-xl mx-auto leading-relaxed">
            Premium <strong className="text-primary font-semibold">3D assets</strong>,{" "}
            <strong className="text-primary font-semibold">Lottie animations</strong>, and{" "}
            <strong className="text-primary font-semibold">SVG icons</strong>—ready to ship.
          </p>
