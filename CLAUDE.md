# Designo — Asset Marketplace Platform
...
RESEND_API_KEY=
EMAIL_FROM="Designo <noreply@yourdomain.com>"  # must be a verified Resend sender
...
- [ ] Verify production sender domain in Resend → set `EMAIL_FROM=Designo <noreply@yourdomain.com>`
